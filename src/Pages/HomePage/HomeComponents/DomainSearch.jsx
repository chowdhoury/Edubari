...
const DomainSearch = () => {
    ...
    const handleSearch = async (e) => {
        ...
        if (!cleanTerm) {
            setError(
                "Please enter a valid name (e.g., myschool or botbari)"
            );
            return;
        }
        ...
        try {
            ...
            if (cleanTerm.includes(".")) {
                ...
                domainsToCheck = COMMON_TLDS.map(
                    (tld) => `${cleanTerm}${tld}`
                );
            }
                ...
                <div className="px-6 sm:px-8 md:px-10 lg:px-12 py-12 sm:py-14">
                    ...
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        <p className="mt-5 text-sm sm:text-[15px] lg:text-base leading-7 text-dark/70 max-w-2xl mx-auto">
                            Enter your institution or brand name and we'll
                            suggest available domains instantly.
                        </p>
                    </div>
                        ...
                        <div className="mt-10 animate-pulse">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
                                {[...Array(6)].map((_, i) => (
                                    <div
                                        key={i}
                                        className="h-[88px] rounded-2xl bg-white/30 border border-white/20"
                                    />
                                ))}
                            </div>
                        </div>
                                    ...
                                    return (
                                        <div
                                            ...
                                            style={{
                                                ...
                                                animation:
                                                    "fadeInUp 0.4s ease-out backwards",
                                            }}
                                        >
                                            {/* Card Content */}
                                            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                                                ...
                                                {/* Action */}
                                                {result.available ? (
                                                    <button className="shrink-0 rounded-xl bg-linear-to-r from-tertiary to-[#8B5CF6] px-4 py-2 text-xs font-bold text-white shadow-sm hover:shadow-md hover:-translate-y-0.5 active:translate-y-0 transition-all duration-300">
                                                        Select
                                                    </button>
                                                ) : (
